                ...
                case "Rice":
                    {
                        ...
                        try
                        {
                            ...
                            var jsonToOutput1 = JsonConvert.SerializeObject(RiceArrary, Formatting.Indented);
                            File.WriteAllText(Path, jsonToOutput1);
                            break;
                        }
                        catch (Exception ex)
                        {
                ...
                case "Pulse":
                    {
                        ...
                        try
                        {
                            ...
                            var jsonToOutput2 = JsonConvert.SerializeObject(PulseArrary, Formatting.Indented);
                            File.WriteAllText(Path, jsonToOutput2);
                            break;
                        }
                        catch (Exception ex)
                        {
                ...
                case "Wheat":
                    {
                        ...
                        try
                        {
                            ...
                            var jsonToOutput3 = JsonConvert.SerializeObject(WheatArrary, Formatting.Indented);
